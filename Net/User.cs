...
namespace Bendyline.Base
{
    ...
    public class User : UserReference
    {
        ...
        {
            HttpRequest xhr = (HttpRequest)this.ensureContentContainerOperation.Tag;
        ...
        public void LoadUser(AsyncCallback callback, object state)
        {
            ...
            if (isNew)
            {
                ...
                xhr.Initialize(HttpRequestType.JsonRead);
        ...
        {
            HttpRequest xhr = (HttpRequest)this.userLoadedOperation.Tag;
